      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mt-14 auto-rows-fr">
          <AnimateIn className="md:col-span-2 lg:col-span-1 lg:row-span-2">
            ...
            >
              <div className="relative bg-navy rounded-lg p-8 h-full flex flex-col justify-between min-h-[320px] card-border-expand overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-navy via-navy-mid to-navy opacity-100" />
                <div className="relative z-10">
                  <Zap className="text-brand-gold" size={28} strokeWidth={1.75} aria-hidden />
                  <h3 className="font-heading font-black text-white text-xl mt-4">
                    Crisis Communications
                  </h3>
                  <p className="text-white/60 text-[15px] leading-relaxed mt-3">
                ...
                <div className="relative z-10 mt-6">
                  <span className="text-brand-gold font-sans font-medium text-sm group-hover:gap-3 inline-flex items-center gap-2 transition-all">
            ...
            return (
              <AnimateIn key={service.slug} delay={(i + 1) * 100}>
                <Link
                  ...
                  className="group block h-full"
                >
                  <div className="bg-white rounded-lg p-6 h-full border border-brand-border/30 hover:border-brand-gold/30 hover:shadow-lg hover:shadow-brand-gold/5 transition-all duration-300">
                    <Icon
                    ...
                    <span className="text-brand-gold font-sans font-medium text-sm mt-4 inline-flex items-center gap-2 group-hover:gap-3 transition-all">
                      Learn more <ArrowRight size={14} aria-hidden />
                    </span>
                  </div>
                </Link>
